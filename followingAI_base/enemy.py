...
class Enemy:
    ...
    def __init__(self,w,h,color,speed,path:Paths):
        self.w = w
        self.h = h
    ...
    def followPath(self):
        self.direction = self.path.points[self.next_pos] - self.path.points[self.current_pos]
